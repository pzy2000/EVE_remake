namespace Starfall.Domain
{
    internal static partial class L10nData
    {
        ...
        private static readonly (string en, string zh)[] GameEntries =
        {
            ...
            ("Sold {0}.", "已出售{0}。"),
            ("Sold {0} for {1} ISK.", "已出售{0}，获得 {1} ISK。"),
            ("Switch to another ship before selling this one.", "请先切换到其他舰船再出售本舰。"),
            ("You cannot sell your only ship.", "不能出售唯一的舰船。"),
            ("{0} refuses to work with you.", "{0}拒绝与你合作。"),
            ("Return to the issuing station to collect the reward.", "请返回发布任务的空间站领取奖励。"),
            ("Fitted {0}.", "已装配{0}。"),
            ("Unfitted {0}.", "已卸下{0}。"),
