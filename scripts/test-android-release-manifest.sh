...
unity_manifest="$temporary_root/unity.xml"
...
printf '%s\n' '<activity android:screenOrientation="11" />' >"$unity_manifest"
...
starfall_manifest_allows_both_landscape_orientations "$unity_manifest"
